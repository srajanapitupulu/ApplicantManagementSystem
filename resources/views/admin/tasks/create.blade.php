...
@section('content')
    <div style="padding: 40px; font-family: Arial, sans-serif; max-width: 600px;">
        <h2 style="font-size: 24px; font-weight: bold; margin-bottom: 20px; color: #333;">Create Task</h2>
        ...
        <form method="POST" action="{{ route('admin.tasks.store') }}">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <textarea name="description" required
                    style="width: 100%; height: 500px; padding: 10px; border: 1px solid #ccc; border-radius: 6px; box-sizing: border-box;"></textarea>
            </div>
